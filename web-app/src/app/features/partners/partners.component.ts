...
@Component({
  ...
  styles: [`
    ...
    .partners-hero {
      background: linear-gradient(155deg, var(--gold-light) 0%, var(--bg-secondary) 60%, var(--bg-tertiary) 100%);
      padding: clamp(5rem, 11vw, 9rem) 1.5rem clamp(3.5rem, 7vw, 6rem);
      text-align: center;
    }
    .partners-hero__inner { max-width: 740px; margin: 0 auto; }
    .eyebrow { font-size: 0.78rem; font-weight: 700; letter-spacing: 0.14em; text-transform: uppercase; color: var(--gold); margin: 0 0 1.1rem; }
    ...
    .hero-stat { text-align: center; strong { display: block; font-family: var(--font-display); font-size: 2.2rem; font-weight: 800; color: var(--gold); letter-spacing: -0.02em; } span { font-size: 0.88rem; color: var(--text-secondary); font-weight: 600; } }

    .section { padding: clamp(3.5rem, 7vw, 6rem) 1.5rem; }
    .section--tinted { background: var(--bg-secondary); }
    .section-inner { max-width: 960px; margin: 0 auto; }
    .section-eye { font-size: 0.78rem; font-weight: 700; letter-spacing: 0.12em; text-transform: uppercase; color: var(--gold); margin: 0 0 0.6rem; }
    ...
    .step-num { width: 44px; height: 44px; border-radius: 50%; background: var(--gold); color: #fff; font-weight: 800; font-size: 1.1rem; display: flex; align-items: center; justify-content: center; margin: 0 auto 0.85rem; }
