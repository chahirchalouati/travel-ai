...
@Component({
  ...
  `,
  styles: [`
    .tc-panel { background: var(--surface, #fff); border: 1px solid var(--line, #e5e7eb); border-radius: 16px; padding: 1.25rem 1.4rem; margin-top: 1.5rem; }
    .tc-eyebrow { display: inline-flex; align-items: center; gap: 6px; font-size: 0.72rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.08em; color: var(--accent, #2563eb); }
    ...
    .tc-skeleton { height: 64px; border-radius: 12px; background: linear-gradient(90deg, #f3f4f6, #e5e7eb, #f3f4f6); background-size: 200% 100%; animation: tc-sh 1.2s infinite; }
    @keyframes tc-sh { 0% { background-position: 200% 0 } 100% { background-position: -200% 0 } }
    .tc-empty { color: var(--muted, #6b7280); font-size: 0.9rem; margin: 0 0 1rem; }
    .tc-list { list-style: none; margin: 0 0 1rem; padding: 0; display: flex; flex-direction: column; gap: 0.6rem; }
    .tc-member { display: flex; align-items: center; gap: 0.7rem; padding: 0.6rem 0.7rem; border: 1px solid var(--line, #e5e7eb); border-radius: 12px; }
    .tc-avatar { flex: 0 0 34px; width: 34px; height: 34px; border-radius: 50%; display: grid; place-items: center; font-size: 0.78rem; font-weight: 800; color: #fff; background: var(--accent, #2563eb); }
    ...
    .tc-member__email { font-size: 0.75rem; color: var(--muted, #6b7280); overflow: hidden; text-overflow: ellipsis; }
    .tc-chip { font-size: 0.68rem; font-weight: 700; padding: 3px 9px; border-radius: 999px; white-space: nowrap; }
    .tc-chip--role { background: var(--accent-soft, #eff6ff); color: var(--accent, #2563eb); }
    ...
    .tc-remove { border: none; background: transparent; color: var(--muted, #6b7280); cursor: pointer; border-radius: 8px; padding: 4px; transition: background 120ms, color 120ms; }
    ...
    .tc-input { flex: 1 1 180px; padding: 0.6rem 0.8rem; border: 1px solid var(--line, #e5e7eb); border-radius: 10px; font: inherit; }
    .tc-input--role { flex: 0 0 130px; }
    .tc-btn { display: inline-flex; align-items: center; gap: 6px; background: var(--accent, #2563eb); color: #fff; border: none; border-radius: 10px; padding: 0.6rem 1.1rem; font-weight: 700; cursor: pointer; transition: filter 120ms; }
