...
@Component({
    ...
    <div class="safety">
      <header class="safety-hero">
        <div class="safety-hero__inner">
          <p class="eyebrow">{{ 'safety.eyebrow' | transloco }}</p>
  ...
  styles: [`
    ...
    .tip-card { display: flex; gap: 1.1rem; background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-md); padding: 1.4rem; }
    .tip-icon-wrap { width: 44px; height: 44px; flex-shrink: 0; border-radius: var(--radius-md); background: var(--color-red-tint); display: flex; align-items: center; justify-content: center; .ms { font-size: 1.4rem; color: var(--color-red-ink); } }
    ...
    .platform-card { background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-md); padding: clamp(2rem, 4vw, 3rem); display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: center; }
    ...
    .trust-badge { display: inline-flex; align-items: center; gap: 5px; padding: 5px 12px; border-radius: var(--radius-sm); background: var(--bg-secondary); border: 1px solid var(--border-light); font-size: 0.78rem; font-weight: 600; color: var(--text-secondary); .ms { font-size: 15px; color: var(--teal); } }
    ...
    .emergency-card { background: var(--bg-secondary); border: 1px solid var(--border); border-radius: var(--radius-md); padding: 1.5rem; }
    ...
    .report-band { display: flex; align-items: center; gap: 1.25rem; background: var(--brand-light); border: 1px solid var(--brand); border-radius: var(--radius-md); padding: 1.5rem 1.75rem; .ms { font-size: 2rem; color: var(--color-red-ink); flex-shrink: 0; } h3 { font-size: 1rem; font-weight: 700; margin: 0 0 4px; } p { font-size: 0.88rem; color: var(--text-secondary); margin: 0; } }
    .report-btn { margin-left: auto; flex-shrink: 0; background: var(--brand); color: #fff; text-decoration: none; font-weight: 700; font-size: 0.88rem; padding: 10px 20px; border-radius: var(--radius-sm); white-space: nowrap; transition: background 140ms ease; &:hover { background: var(--brand-hover); } }
